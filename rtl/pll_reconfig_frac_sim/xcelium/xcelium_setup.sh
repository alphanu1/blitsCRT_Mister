...
TOP_LEVEL_NAME="pll_reconfig_frac"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/home/ben/intelFPGA_lite/24.1std/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/pll_reconfig_frac/
...
if [ $SKIP_COM -eq 0 ]; then
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_pll_reconfig/altera_pll_reconfig_top.v"  -work pll_reconfig_frac -cdslib ./cds_libs/pll_reconfig_frac.cds.lib
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_pll_reconfig/altera_pll_reconfig_core.v" -work pll_reconfig_frac -cdslib ./cds_libs/pll_reconfig_frac.cds.lib
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_pll_reconfig/altera_std_synchronizer.v"  -work pll_reconfig_frac -cdslib ./cds_libs/pll_reconfig_frac.cds.lib
  xmvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_reconfig_frac.v"                                                                                                
fi
